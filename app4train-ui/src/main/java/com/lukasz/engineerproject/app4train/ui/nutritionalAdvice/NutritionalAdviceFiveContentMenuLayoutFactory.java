...
public class NutritionalAdviceFiveContentMenuLayoutFactory {
	...
	private class NutritionalAdviceFiveContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfNutritionalAdviceFive;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public NutritionalAdviceFiveContentMenuLayout init() {

			topicOfOfNutritionalAdviceFive = new Label(UtilsForNutritionalAdvicesTitles.TOPIC_FIVE.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceFive);
