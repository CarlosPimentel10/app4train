...
public class ArticleEightContentMenuLayoutFactory {
	...
	private class ArticleEightContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfArticleEight;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public ArticleEightContentMenuLayout init() {

			topicOfOfArticleEight = new Label(UtilsForArticlesTitles.TOPIC_EIGHT.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleEight);
