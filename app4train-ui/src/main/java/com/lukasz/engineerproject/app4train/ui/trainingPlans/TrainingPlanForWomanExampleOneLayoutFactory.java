...
@SpringView(name = TrainingPlanForWomanExampleOneLayoutFactory.NAME, ui = App4TrainMainUI.class)
public class TrainingPlanForWomanExampleOneLayoutFactory extends VerticalLayout implements View {

	public static final String NAME = "dlakobiet-przyk³ad1";
	...
	private void prepareButtonForFirstTraining() {
		...
		buttonForFirstTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayOne.addRow("2", "Wyciskanie hantli na ³awce skoœnej (skos dodatni)", 15, 1, 60);
				trainingPlanTableForDayOne.addRow("3", "Wyciskanie hantli nad g³owe w pozycji siedz¹cej", 15, 1, 60);
				trainingPlanTableForDayOne.addRow("4", "Unoszenie ramion w bok z wykorzystaniem gumy oporowej", 15, 1, 60);
				trainingPlanTableForDayOne.addRow("5", "Prostowanie przedramion z wykorzystaniem wyci¹gu górnego", 15,
						1, 60);
				trainingPlanTableForDayOne.addRow("6", "Podci¹ganie sztangi trzymanej nachwytem w opadzie tu³owia", 15,
						1, 60);
				trainingPlanTableForDayOne.addRow("7",
						"Naprzemianstronne uginanie przedramion z wykorzystaniem\r\n" + " gumy oporowej",
						15, 1, 60);
				trainingPlanTableForDayOne.addRow("8", "Prostowanie nóg na maszynie", 15, 1, 60);
				trainingPlanTableForDayOne.addRow("9", "Przysiady z wykorzystaniem kettlebell", 15, 1, 60);
				trainingPlanTableForDayOne.addRow("10", "Wspiêcia na palce na maszynie (³ydki)", 15, 1, 60);
	...
	private void prepareButtonForSecondTraining() {
		...
		buttonForSecondTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayTwo.addRow("1", "\"Rozpiêtki\" z hantelkami na ³awce p³askiej", 15, 1, 60);
				trainingPlanTableForDayTwo.addRow("2", "Wyciskanie hantli na ³awce p³askiej", 15, 1, 60);

				trainingPlanTableForDayTwo.addRow("3", "Podci¹ganie sztangi ³amanej do brody", 15, 1, 60);
				trainingPlanTableForDayTwo.addRow("4", "Wykroki z wykorzystaniem kettlebell", 15, 1, 60);
				trainingPlanTableForDayTwo.addRow("5", "Uginanie nóg w pozycji le¿¹cej na maszynie", 15, 1, 60);
				trainingPlanTableForDayTwo.addRow("6", "Wspiêcia na palce na maszynie (³ydki)", 15, 1, 60);
				trainingPlanTableForDayTwo.addRow("7", "Podci¹ganie sztangi trzymanej podchwytem w opadzie tu³owia", 15,
						1, 60);
				trainingPlanTableForDayTwo.addRow("8",
						...
						15, 1, 60);
				trainingPlanTableForDayTwo.addRow("9",
						"Naprzemianstronne uginanie przedramion z wykorzystaniem gumy oporowej", 15, 1, 60);
	...
	private void prepareButtonForThirdTraining() {
		...
		buttonForThirdTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayThree.addRow("2", "Pompki damskie na kolanach", 15, 1, 60);
				trainingPlanTableForDayThree.addRow("3", "Podci¹ganie sztangi trzymanej podchwytem w opadzie tu³owia",
						15, 1, 60);
				trainingPlanTableForDayThree.addRow("4", "Podci¹ganie sztangi trzymanej nachwytem w opadzie tu³owia",
						15, 1, 60);
				trainingPlanTableForDayThree.addRow("5", "Przyci¹ganie dr¹¿ka wyci¹gu górnego do klatki piersiowej  ",
						15, 1, 60);
				trainingPlanTableForDayThree.addRow("6", "Prostowanie nóg na maszynie", 15, 1, 60);
				trainingPlanTableForDayThree.addRow("7", "Przysiady z wykorzystaniem kettlebell", 15, 1, 60);
				trainingPlanTableForDayThree.addRow("8", "Wykroki z hantelkami", 15, 1, 60);
				trainingPlanTableForDayThree.addRow("9", "Wspiêcia na palce na maszynie (³ydki)", 15, 1, 60);
