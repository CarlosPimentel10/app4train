...
public class ArticleTwoContentMenuLayoutFactory {
	...
	private class ArticleTwoContentMenuLayout extends VerticalLayout {
		...
		public ArticleTwoContentMenuLayout init() {
			...
			Label topicOfOfArticleTwo = new Label(ArticlesTitles.TOPIC_TWO.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleTwo);
