...
@SpringView(name = TrainingPlanForWomanExampleTwoLayoutFactory.NAME, ui = App4TrainMainUI.class)
public class TrainingPlanForWomanExampleTwoLayoutFactory extends VerticalLayout implements View {
		...
		buttonForFirstTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayOne.addRow("2", "Wyciskanie sztangi na ³awce p³askiej",
						"od 8 do 10", 3, 90);
				trainingPlanTableForDayOne.addRow("3", "Pompki damskie na kolanach", "od 8 do 10", 3, 60);
				trainingPlanTableForDayOne.addRow("4", "Wyciskanie hantli na ³awce p³askiej (skos dodatni)",
						"od 8 do 12", 3, 90);
				trainingPlanTableForDayOne.addRow("5", "Podci¹ganie do brody z wykorzystaniem kettlebell", "od 8 do 12", 3, 90);
		...
		buttonForSecondTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayTwo.addRow("5",
						"Prostowanie przedramion z wykorzystaniem kettlebell ", "10", 3, 60);
				trainingPlanTableForDayTwo.addRow("6", "Zginanie przedramion w podporze ty³em na ³aweczce", "10", 3,
						60);
	...
	private void prepareButtonForThirdTraining() {
		...
		buttonForThirdTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayThree.addRow("3", "Przysiady z wykorzystaniem kettlebell", 15, 3, 90);
				trainingPlanTableForDayThree.addRow("4", "Wykroki z wykorzystaniem kettlebell", 10, 3, 60);
				...
				trainingPlanTableForDayThree.addRow("7",
						"Unoszenie ramion w bok z wykorzystaniem gumy oporowej", 10, 3, 60);
				trainingPlanTableForDayThree.addRow("8", "Podci¹ganie sztangi ³amanej do brody", 12, 2, 90);
				trainingPlanTableForDayThree.addRow("9",
						"Unoszenie ramion w przód z wykorzystaniem kettlebell", 12, 2,
						90);
