...
public class ArticleTenContentMenuLayoutFactory {
	...
	private class ArticleTenContentMenuLayout extends VerticalLayout {
		...
		public ArticleTenContentMenuLayout init() {
			...
			Label topicOfOfArticleTen = new Label(ArticlesTitles.TOPIC_TEN.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleTen);
