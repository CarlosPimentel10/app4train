...
public class ArticleThirteenContentMenuLayoutFactory {
	...
	private class ArticleThirteenContentMenuLayout extends VerticalLayout {
		...
		public ArticleThirteenContentMenuLayout init() {
			...
			Label topicOfOfArticleThirteen = new Label(ArticlesTitles.TOPIC_THIRTEEN.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleThirteen);
