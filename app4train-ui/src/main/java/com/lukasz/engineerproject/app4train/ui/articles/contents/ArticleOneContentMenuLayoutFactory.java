...
public class ArticleOneContentMenuLayoutFactory {
	...
	private class ArticleOneContentMenuLayout extends VerticalLayout {
		...
		public ArticleOneContentMenuLayout init() {
			...
			Label topicOfOfArticleOne = new Label(ArticlesTitles.TOPIC_ONE.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleOne);
