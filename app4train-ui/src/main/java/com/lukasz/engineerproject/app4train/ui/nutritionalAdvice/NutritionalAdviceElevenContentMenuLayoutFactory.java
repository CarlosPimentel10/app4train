...
public class NutritionalAdviceElevenContentMenuLayoutFactory {
	...
	private class NutritionalAdviceElevenContentMenuLayout extends VerticalLayout {
		...
		public NutritionalAdviceElevenContentMenuLayout init() {
			...
			Label topicOfOfNutritionalAdviceEleven = new Label(NutritionalAdvicesTitles.TOPIC_ELEVEN.getString());

			prepareButton();

			buttonAction();

			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceEleven);
