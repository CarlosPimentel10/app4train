...
public class NutritionalAdviceSevenContentMenuLayoutFactory {
	...
	private class NutritionalAdviceSevenContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfNutritionalAdviceSeven;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public NutritionalAdviceSevenContentMenuLayout init() {

			topicOfOfNutritionalAdviceSeven = new Label(UtilsForNutritionalAdvicesTitles.TOPIC_SEVEN.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceSeven);
