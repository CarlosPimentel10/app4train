...
public class NutritionalAdviceTwentyContentMenuLayoutFactory {
	...
	private class NutritionalAdviceTwentyContentMenuLayout extends VerticalLayout {
		...
		public NutritionalAdviceTwentyContentMenuLayout init() {
			...
			Label topicOfOfNutritionalAdviceTwenty = new Label(NutritionalAdvicesTitles.TOPIC_TWENTY.getString());

			prepareButton();

			buttonAction();

			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceTwenty);
