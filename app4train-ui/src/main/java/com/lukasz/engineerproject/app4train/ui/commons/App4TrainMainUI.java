...
public class App4TrainMainUI extends UI {
	...
	@Autowired
	private App4TrainMenuFactory menuFactory;

	@Autowired
	private App4TrainLogoLayoutFactory logoFactory;
	...
	protected void init(VaadinRequest request) {
		...
		getPage().getStyles().add(".page-ui{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles()
				.add(".tree{font-size: 14px; font-family: 'BenchNine'; color: #ffffff; background-color:#333}");
		getPage().getStyles().add(".content{background-color:#e8e8e8}");
		getPage().getStyles().add(".throughtExplanationOfArticleOne{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleTwo{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleThree{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleFour{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleFive{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleSix{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleSeven{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleEight{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleNine{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleTen{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleEleven{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleTwelve{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleThirteen{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleFourteen{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleFifteen{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleSixteen{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleSeventeen{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleEighteen{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleNineteen{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfArticleTwenty{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfEctomorphicType{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfMesomorphicType{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".throughtExplanationOfEndomorphicType{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".trainingPlanTableForDayOneExampleOne{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".trainingPlanTableForDayTwoExampleOne{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles()
				.add(".trainingPlanTableForDayThreeExampleOne{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".trainingPlanTableForDayOneExampleTwo{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles().add(".trainingPlanTableForDayTwoExampleTwo{font-size: 16px; font-family: 'BenchNine';}");
		getPage().getStyles()
		...
		layoutForAllContent.addComponents(layoutForLogoMenuContent, labelForSocialMediaButtons,
				layoutForSocalMediaButtons, footer);//
