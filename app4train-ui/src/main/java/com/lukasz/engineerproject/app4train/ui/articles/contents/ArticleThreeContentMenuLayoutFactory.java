...
public class ArticleThreeContentMenuLayoutFactory {
	...
	private class ArticleThreeContentMenuLayout extends VerticalLayout {
		...
		public ArticleThreeContentMenuLayout init() {
			...
			Label topicOfOfArticleThree = new Label(ArticlesTitles.TOPIC_THREE.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleThree);
