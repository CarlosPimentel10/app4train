...
public class NutritionalAdviceNineteenContentMenuLayoutFactory {
	...
	private class NutritionalAdviceNineteenContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfNutritionalAdviceNineteen;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public NutritionalAdviceNineteenContentMenuLayout init() {

			topicOfOfNutritionalAdviceNineteen = new Label(UtilsForNutritionalAdvicesTitles.TOPIC_NINETEEN.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceNineteen);
