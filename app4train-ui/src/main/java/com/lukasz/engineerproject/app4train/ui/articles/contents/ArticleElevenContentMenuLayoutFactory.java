...
public class ArticleElevenContentMenuLayoutFactory {
	...
	private class ArticleElevenContentMenuLayout extends VerticalLayout {
		...
		public ArticleElevenContentMenuLayout init() {
			...
			Label topicOfOfArticleEleven = new Label(ArticlesTitles.TOPIC_ELEVEN.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleEleven);
