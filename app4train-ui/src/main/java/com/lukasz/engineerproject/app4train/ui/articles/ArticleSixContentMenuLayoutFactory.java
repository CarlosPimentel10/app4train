...
public class ArticleSixContentMenuLayoutFactory {
	...
	private class ArticleSixContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfArticleSix;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public ArticleSixContentMenuLayout init() {

			topicOfOfArticleSix = new Label(UtilsForArticlesTitles.TOPIC_SIX.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleSix);
