...
public class NutritionalAdviceThirteenContentMenuLayoutFactory {
	...
	private class NutritionalAdviceThirteenContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfNutritionalAdviceThirteen;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public NutritionalAdviceThirteenContentMenuLayout init() {

			topicOfOfNutritionalAdviceThirteen = new Label(UtilsForNutritionalAdvicesTitles.TOPIC_THIRTEEN.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceThirteen);
