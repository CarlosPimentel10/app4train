...
public class NutritionalAdviceOneContentMenuLayoutFactory {
	...
	private class NutritionalAdviceOneContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfNutritionalAdviceOne;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public NutritionalAdviceOneContentMenuLayout init() {

			topicOfOfNutritionalAdviceOne = new Label(UtilsForNutritionalAdvicesTitles.TOPIC_ONE.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceOne);
