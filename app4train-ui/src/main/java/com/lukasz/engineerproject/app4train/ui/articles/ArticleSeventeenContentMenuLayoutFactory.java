...
public class ArticleSeventeenContentMenuLayoutFactory {
	...
	private class ArticleSeventeenContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfArticleSeveteen;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public ArticleSeventeenContentMenuLayout init() {

			topicOfOfArticleSeveteen = new Label(UtilsForArticlesTitles.TOPIC_SEVENTEEN.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleSeveteen);
