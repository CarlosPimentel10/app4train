...
public class ArticleSevenContentMenuLayoutFactory {
	...
	private class ArticleSevenContentMenuLayout extends VerticalLayout {
		...
		public ArticleSevenContentMenuLayout init() {
			...
			Label topicOfOfArticleSeven = new Label(ArticlesTitles.TOPIC_SEVEN.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleSeven);
