...
public class ArticleNineContentMenuLayoutFactory {
	...
	private class ArticleNineContentMenuLayout extends VerticalLayout {
		...
		public ArticleNineContentMenuLayout init() {
			...
			Label topicOfOfArticleNine = new Label(ArticlesTitles.TOPIC_NINE.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleNine);
