...
@SpringView(name = TrainingPlanForWomanExampleThreeLayoutFactory.NAME, ui = App4TrainMainUI.class)
public class TrainingPlanForWomanExampleThreeLayoutFactory extends VerticalLayout implements View {

	public static final String NAME = "dlakobiet-przyk³ad3";
	...
	private void prepareButtonForFirstTraining() {
		...
		buttonForFirstTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayOne.addRow("1", "\"Rozpiêtki\" z hantlami na ³awce p³askiej", "15", 3,
						45);
				trainingPlanTableForDayOne.addRow("2", "Wyciskanie sztangi na ³awce p³askiej",
						"15", 3, 60);
				trainingPlanTableForDayOne.addRow("3", "Pompki damskie na kolanach", "15", 3, 60);
				trainingPlanTableForDayOne.addRow("4", "Wyciskanie hantli na ³awce p³askiej (skos dodatni)",
						"15", 3, 60);
				trainingPlanTableForDayOne.addRow("5", "Podci¹ganie do brody z wykorzystaniem kettlebell", "15", 3, 60);
				trainingPlanTableForDayOne.addRow("6", "Podci¹ganie hantli w klêku podpartym na ³awce", "15", 2, 60);
		...
		buttonForSecondTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayTwo.addRow("2",
						"Uginanie przedramion w pozycji stoj¹cej z wykorzystaniem sztangi ³amanej", "15", 3,
						45);
				...
				trainingPlanTableForDayTwo.addRow("4",
						"Prostowanie przedramion przy wykorzystaniu wyci¹gu górnego z u¿yciem linek", "15", 3, 45);
				trainingPlanTableForDayTwo.addRow("5",
						"Prostowanie przedramion z wykorzystaniem kettlebell ", "15", 3, 45);
				trainingPlanTableForDayTwo.addRow("6", "Zginanie przedramion w podporze ty³em na ³aweczce", "15", 3,
						45);
				trainingPlanTableForDayTwo.addRow("7",
						"Prostowanie przedramion z wykorzystaniem wyci¹gu górnego podchwytem", "15", 3, 60);
	...
	private void prepareButtonForThirdTraining() {
		...
		buttonForThirdTraining.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				trainingPlanTableForDayThree.addRow("1", "Prostowanie nóg na maszynie", 15, 3, 45);
				trainingPlanTableForDayThree.addRow("2", "Wyciskanie ciê¿aru na suwnicy skoœnej", 15, 3, 60);
				trainingPlanTableForDayThree.addRow("3", "Przysiady z wykorzystaniem kettlebell", 15, 3, 60);
				trainingPlanTableForDayThree.addRow("4", "Wykroki z wykorzystaniem kettlebell", 15, 3, 45);
				trainingPlanTableForDayThree.addRow("5", "Uginanie nóg w pozycji le¿¹cej na maszynie", 15, 3, 45);
				trainingPlanTableForDayThree.addRow("6", "Wspiêcia na palce na maszynie (³ydki)", 15, 3, 45);
				trainingPlanTableForDayThree.addRow("7",
						"Unoszenie ramion w bok z wykorzystaniem gumy oporowej", 15, 3, 60);
				trainingPlanTableForDayThree.addRow("8", "Podci¹ganie sztangi ³amanej do brody", 15, 3, 60);
				trainingPlanTableForDayThree.addRow("9",
						"Unoszenie ramion w przód z wykorzystaniem kettlebell", 15, 3,
						60);
