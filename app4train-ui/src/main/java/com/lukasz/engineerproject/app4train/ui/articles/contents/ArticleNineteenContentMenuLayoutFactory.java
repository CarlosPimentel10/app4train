...
public class ArticleNineteenContentMenuLayoutFactory {
	...
	private class ArticleNineteenContentMenuLayout extends VerticalLayout {
		...
		public ArticleNineteenContentMenuLayout init() {
			...
			Label topicOfOfArticleNineteen = new Label(ArticlesTitles.TOPIC_NINETEEN.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleNineteen);
