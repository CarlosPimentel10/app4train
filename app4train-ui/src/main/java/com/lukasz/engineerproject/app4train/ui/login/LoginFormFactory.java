...
public class LoginFormFactory {
	...
	private class LoginForm {
		...
		public LoginForm init() {
			...
			preparePanelForLogin();

			prepareTextFields();

			prepareSaveAndSignUpButtons();

			prepareLayoutForLoginForm();
		...
		private void preparePanelForLogin() {
		...
		private void prepareLayoutForLoginForm() {
		...
		private void prepareSaveAndSignUpButtons() {
