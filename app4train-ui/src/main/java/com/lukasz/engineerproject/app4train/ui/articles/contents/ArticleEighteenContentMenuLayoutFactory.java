...
public class ArticleEighteenContentMenuLayoutFactory {
	...
	private class ArticleEighteenContentMenuLayout extends VerticalLayout {
		...
		public ArticleEighteenContentMenuLayout init() {
			...
			Label topicOfOfArticleEighteen = new Label(ArticlesTitles.TOPIC_EIGHTEEN.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleEighteen);
