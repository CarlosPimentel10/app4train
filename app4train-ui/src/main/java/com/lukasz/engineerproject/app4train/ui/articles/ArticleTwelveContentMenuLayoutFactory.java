...
public class ArticleTwelveContentMenuLayoutFactory {
	...
	private class ArticleTwelveContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfArticleTwelve;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public ArticleTwelveContentMenuLayout init() {

			topicOfOfArticleTwelve = new Label(UtilsForArticlesTitles.TOPIC_TWELVE.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleTwelve);
