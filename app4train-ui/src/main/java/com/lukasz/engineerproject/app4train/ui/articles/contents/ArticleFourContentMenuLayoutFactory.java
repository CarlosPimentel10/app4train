...
public class ArticleFourContentMenuLayoutFactory {
	...
	private class ArticleFourContentMenuLayout extends VerticalLayout {
		...
		public ArticleFourContentMenuLayout init() {
			...
			Label topicOfOfArticleFour = new Label(ArticlesTitles.TOPIC_FOUR.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleFour);
