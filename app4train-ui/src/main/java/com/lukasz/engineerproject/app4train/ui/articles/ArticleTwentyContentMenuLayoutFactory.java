...
public class ArticleTwentyContentMenuLayoutFactory {
	...
	private class ArticleTwentyContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfArticleTwenty;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public ArticleTwentyContentMenuLayout init() {

			topicOfOfArticleTwenty = new Label(UtilsForArticlesTitles.TOPIC_TWENTY.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleTwenty);
