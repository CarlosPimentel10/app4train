...
public class ArticleFiveContentMenuLayoutFactory {
	...
	private class ArticleFiveContentMenuLayout extends VerticalLayout {
		...
		public ArticleFiveContentMenuLayout init() {
			...
			Label topicOfOfArticleFive = new Label(ArticlesTitles.TOPIC_FIVE.getString());
			...
			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfArticleFive);
