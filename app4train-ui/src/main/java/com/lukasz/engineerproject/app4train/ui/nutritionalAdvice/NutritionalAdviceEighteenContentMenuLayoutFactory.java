...
public class NutritionalAdviceEighteenContentMenuLayoutFactory {
	...
	private class NutritionalAdviceEighteenContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfNutritionalAdviceEighteen;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public NutritionalAdviceEighteenContentMenuLayout init() {

			topicOfOfNutritionalAdviceEighteen = new Label(UtilsForNutritionalAdvicesTitles.TOPIC_EIGHTEEN.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceEighteen);
