...
public class NutritionalAdviceTwoContentMenuLayoutFactory {
	...
	private class NutritionalAdviceTwoContentMenuLayout extends VerticalLayout {
		...
		public NutritionalAdviceTwoContentMenuLayout init() {
			...
			Label topicOfOfNutritionalAdviceTwo = new Label(NutritionalAdvicesTitles.TOPIC_TWO.getString());

			prepareButton();

			buttonAction();

			HorizontalLayout layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceTwo);
