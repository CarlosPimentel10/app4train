...
public class NutritionalAdviceEightContentMenuLayoutFactory {
	...
	private class NutritionalAdviceEightContentMenuLayout extends VerticalLayout {
		...
		private Label topicOfOfNutritionalAdviceEight;
		private HorizontalLayout layoutForButtonAndWindow;
		private Button buttonForWindow;

		public NutritionalAdviceEightContentMenuLayout init() {

			topicOfOfNutritionalAdviceEight = new Label(UtilsForNutritionalAdvicesTitles.TOPIC_EIGHT.getString());
			...
			layoutForButtonAndWindow = new HorizontalLayout(buttonForWindow, topicOfOfNutritionalAdviceEight);
